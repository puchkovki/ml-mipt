...
class ThreeInputsNet(nn.Module):
    def __init__(self, n_tokens, n_cat_features, concat_number_of_features, hid_size=64):
        ...
        self.title_proc = nn.Sequential(nn.Conv1d(in_channels=hid_size,
        ...
        self.full_proc = nn.Sequential(nn.Conv1d(in_channels=hid_size,
        ...
        self.category_out = nn.Sequential(nn.Linear(n_cat_features, n_cat_features),
        								  nn.Linear(n_cat_features, n_cat_features),
        								  # nn.Flatten()
        								  )
